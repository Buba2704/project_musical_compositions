 ...
 * @author PC
 */
public class FormNoviAutor extends javax.swing.JDialog {

    public FormNoviAutor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        txtEmail.setText("dino@gmail.com");
    ...
    private void btnDodajActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDodajActionPerformed
        try {
            ...
            Autor a = new Autor(null, ime, prezime, email, telefon);
            
            ClientController.getInstance().addAutor(a);
            MainForm mf = (MainForm) getParent();
            mf.popuniAutore();
            JOptionPane.showMessageDialog(this, "Uspesno dodat autor.");
            this.dispose();
