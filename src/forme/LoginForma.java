...
public class LoginForma extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtUsername.setText("ljubica");

        txtPassword.setText("ljubica123");
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        try {
            MuzickiUrednik mu = new MuzickiUrednik();
            mu.setUsername(txtUsername.getText());
            mu.setPassword(new String(txtPassword.getPassword()));
            MuzickiUrednik muzickiUrednik = ClientController.getInstance().login(mu);
            Session.getInstance().setUlogovani(muzickiUrednik);
